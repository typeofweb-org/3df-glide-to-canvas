...
import { GrTextureFormat_t, } from "./glide.js";
...
function getDataFor(name, ui8Array) {
...
async function printFile(name) {
    ...
    packedResult.forEach((result, i) => {
        ...
        return renderToCanvas(metadata, metadata.name, metadata.width, metadata.height, data);
    });
}
function renderToCanvas(metadata, name, width, height, data) {
